...
Scala не только очень эффективный, но также и большой язык, полученный 
опыт, научил нас быть очень осторожным при его использовании на практике в своем приложении. Где скрыты подводные камни? Какие особенности стоит использвать, а от каких отказаться? Когда мы можем использовать «чисто функциональный стиль», а когда его следует избегать? Другими словами: что мы используем, чтобы быть более эффективным при использовании языка? Это руководство пытается передать наш опыт в коротких заметках, представляя набор *лучших практик*. Мы используем Scala в основном для создания высококачественных услуг, которые представляют собой распределенные системы - и наше мнение будет предвзято - но большинство советов здесь должны работать без проблем и 
при переносе на другие системы. Это не закон, но отклонение должно
быть вполне приемлимым.


Scala предоставляет множество инструментов, которые позволяют кратко описывать свои действия. Если мы меньше будем набирать символов, значит меньше придется читать, а значит исходный код будет прочитан быстрее, следовательно, краткость повышает ясность. Однако краткость может быть и тупым инструментом, который может оказать обратный эффект: после правильности, всегда нужно думать о читателе.

Немного, о *программе на Scala*. Вы не пишете код ни на Java, ни на Haskell, ни на Python; написание Scala-программы отличается от написания в любом из них. Для того чтобы использовать язык эффективно, вы должны описать свои проблемы, в терминах этого языка. Вас никто не принуждает использовать программу, написанную на Java, в Scala, в большинстве случаев она будет уступать оригиналу.

Это не введение в язык Scala, мы предполагаем, что читатель
знаком с языком. Вот некоторые ресурсы для обучения Scala:

* [Scala School](http://twitter.github.com/scala_school/)
* [Learning Scala](http://www.scala-lang.org/node/1305)
* [Learning Scala in Small Bites](http://matt.might.net/articles/learning-scala-in-small-bites/)

Это живой документ, который будет меняться с учетом наших текущих
"лучших практик", но его основные идеи вряд ли изменятся: код должен быть всегда легко читаемым; писать универсальный код, но не в ущерб
...
Специфические особенности *форматирования кода* - пока они практичны -
...
может быть вызваны с помощью "`.`", либо с пробелом, либо без круглой скобки для не возвращающих значений или унарных методов, с круглой скобкой для них, и так далее. Кроме того, различные стили вызова метода оставляют двусмысленность в его грамматике! Конечно, последовательное
применение тщательно выбранного набора правил форматирования решит
большую двусмысленность и для человека и для машины.

Мы придерживаемся [Scala Правила форматирования] (http://docs.scala-lang.org/style/) и дополнительно следующих правил.
